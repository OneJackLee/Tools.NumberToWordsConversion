...
public class NumberToWordsConverterServiceTests
{
    ...
    public void GetAmountToWords_ShouldReturnAmountInWords_WhenAmountIsMax()
    {
        ...
        // Assert
        result.Should().Be("OCTILLION EIGHT BILLION FIVE HUNDRED AND EIGHTY-NINE MILLION NINE HUNDRED AND THIRTY-FOUR THOUSAND FIVE HUNDRED AND NINETY-ONE DOLLARS");
    }
}
